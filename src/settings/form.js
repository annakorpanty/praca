 ...
 * @param {{ dayInput: HTMLInputElement | null; nightInput: HTMLInputElement | null; anyInput: HTMLInputElement | null; }} inputs
 * @returns {{ maxStreak: { D: number; N: number; ANY: number } }}
 */
